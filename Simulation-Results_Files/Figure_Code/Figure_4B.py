...
# Ensure Helvetica font is available
helvetica_path = '/Users/shashankpritam/Downloads/helvetica.ttf'  # Update this path to the location of Helvetica.ttf on your system
...
def plot_bar_metrics(data):
    ...
    sample_order = ['bm50', 'b0', 'b50']  # This defines the desired order
    ...
    ax.set_ylabel('Minimum Fitness Values', fontsize=24)
    ...
    # Adjust grid lines: only horizontal grid lines
    ax.yaxis.grid(False)
    ax.xaxis.grid(False)
