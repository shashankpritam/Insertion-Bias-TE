...
def insert_into_duckdb(dfs):
    conn = duckdb.connect(database='fitness.duckdb', read_only=False)
    try:
        conn.execute("""
...
def main():
    files = ["/Users/shashankpritam/github/Insertion-Bias-TE/Simulation-Results_Files/simulation_storm/fitness/fitness_Simulation_exploration.txt"]
